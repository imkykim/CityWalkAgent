#!/usr/bin/env python3
"""
CLIP + K-NN Validation — validate VLM scores against MIT Place Pulse 2.0.

Usage:
    python validate.py --input data/results/analysis_results.json
    python validate.py --input results/route1.json results/route2.json --k 10 --use-cache
"""
...
Examples:
  # Basic validation
  python validate.py --input results/analysis_results.json

  # With custom K and caching
  python validate.py --input results/analysis_results.json --k 15 --use-cache

  # Use different CLIP model
  python validate.py --input results/analysis_results.json --clip-model ViT-L/14

  # Merge multiple analysis files
  python validate.py --input results/route1.json results/route2.json --k 10

  # Skip plots (faster)
  python validate.py --input results/analysis_results.json --skip-plots
        """,
    )
